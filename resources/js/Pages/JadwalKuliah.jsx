...
const JadwalKuliah = () => {
    ...
    const dummyHariIni = [
        {
            jam: "08:00 - 10:30",
            mata_kuliah: "Jaringan Komputer II (TP)",
            dosen: "Rofiq Fauzi",
            ruangan: "EL | Lab. Jaringan Komputer",
        },
        {
            jam: "13:00 - 15:30",
            mata_kuliah: "Pancasila (T)",
            dosen: "NUR HIDAYATI",
            ruangan: "EL | MST-306",
        },
    ];

    const displayHariIni =
        jadwal_hari_ini.length > 0 ? jadwal_hari_ini : dummyHariIni;
